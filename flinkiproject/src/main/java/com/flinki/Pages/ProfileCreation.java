...
public class ProfileCreation extends base {
    ...
    public void addNewraceEvent()

    {   Profile.clickElement(addNewRaceEvent);
        Profile.enterText(typeOfCreate ,Profile.randomstring());
        Profile.enterText(startDate, "20/05/2025");
        Profile.enterText(endDate, "01/06/2025");
